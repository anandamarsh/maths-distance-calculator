...
1. Preserve all {placeholder} tokens exactly as-is (e.g. {count}, {email}, {level}, {n}, {answer}, {value}).
2. Do not translate URLs.
3. Do not translate brand names like "SeeMaths", "Distance Calculator", "DiscussIt".
